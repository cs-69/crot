...
wget -q -O /tmp/sshd_config https://raw.githubusercontent.com/cs-69/crot/refs/heads/main/config/sshd_config && sudo mv /tmp/sshd_config /etc/ssh/sshd_config;
systemctl restart ssh;
wget -q -O /tmp/resolv.conf https://raw.githubusercontent.com/cs-69/crot/refs/heads/main/config/resolv.conf && sudo mv /tmp/resolv.conf /etc/resolv.conf;
